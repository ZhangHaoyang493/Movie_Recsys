...
from sort.AutoInt.model import AutoInt
...
def parse_args():
    ...
    parser.add_argument("--config", "-c", type=str, default="/data2/zhy/Movie_Recsys/sort/AutoInt/feature_autoint.json", help="Path to config file")
    parser.add_argument("--lr", type=float, default=1e-3, help="Learning rate")
    parser.add_argument("--min_lr", type=float, default=1e-5, help="Minimum learning rate")
    parser.add_argument("--lr_milestones", type=int, nargs='+', default=[10000, 200000], help="Learning rate decay milestones")
...
if __name__ == "__main__":
    ...
    # }
    model = AutoInt(config_path, {'movies_dataloader': movies_dataloader, 'val_dataloader': val_dataloader}, hparams=vars(args))
