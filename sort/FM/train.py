...
def parse_args():
    ...
    parser.add_argument("--config", "-c", type=str, default="/data2/zhy/Movie_Recsys/sort/FM/feature_fm.json", help="Path to config file")
...
if __name__ == "__main__":
    ...
    # }
    model = FM(config_path, {'movies_dataloader': movies_dataloader, 'val_dataloader': val_dataloader}, hparams=vars(args))
