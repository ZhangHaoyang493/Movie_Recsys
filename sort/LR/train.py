...
def parse_args():
    ...
    parser.add_argument("--config", "-c", type=str, default="feature_LR.json", help="Path to config file")
...
if __name__ == "__main__":
    ...
    # }
    model = LR(config_path, {'movies_dataloader': movies_dataloader, 'val_dataloader': val_dataloader}, hparams=vars(args))
