...
from sort.DeepFM.model import DeepFM
...
def parse_args():
    ...
    parser.add_argument("--config", "-c", type=str, default="/data2/zhy/Movie_Recsys/sort/DeepFM/feature_deepfm.json", help="Path to config file")
...
if __name__ == "__main__":
    ...
    # }
    model = DeepFM(config_path, {'movies_dataloader': movies_dataloader, 'val_dataloader': val_dataloader}, hparams=vars(args))
